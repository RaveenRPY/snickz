...
class AppColors {
  ...
  static const Color promoDiscountColor = Color(0xFFFF0000);
  static const Color textBlueColor = Color(0xFF212551);
  static const Color cardContainerColor = Color(0xFFBBBDC5);
}
